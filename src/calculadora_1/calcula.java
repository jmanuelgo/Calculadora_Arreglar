...
private char ope;
    ...
    public calcula() {
        initComponents();
        calcu1=new Calculadora_1("casio");
    }
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        ...
        jLabel1.setText("");
        switch (ope){
            case '+':{resultado=calcu1.sumar(num1,num2);
            jLabel1.setText(""+resultado);
            }
            case '-':{resultado=calcu1.restar(num1,num2);
            jLabel1.setText(""+resultado);
            }
            case '*':{resultado=calcu1.multi(num1,num2);
            jLabel1.setText(""+resultado);
            }
            case '/':{resultado=calcu1.div(num1,num2);
            jLabel1.setText(""+resultado);
